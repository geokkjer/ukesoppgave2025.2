...
export default class LoginView extends HTMLElement {
    ...
    constructor() {
        super();
        this.attachShadow({ mode: 'open' }); // Bruker Shadow DOM for å kapsle inn innhold
    }

    /**
     * Setter dispatch-funksjonen slik at vi kan sende actions til rendereren.
     */
    ...
    connectedCallback() {
        this.render(); // Renderes når elementet legges til i DOM
    }

    /**
     * Bygger HTML for login-skjemaet.
     */
    render() {
    ...
    /**
     * Event listeners for login-knappen.
     */
